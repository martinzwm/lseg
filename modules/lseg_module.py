...
class LSegModule(LSegmentationModule):
    def __init__(self, data_path, dataset, batch_size, base_lr, max_epochs, **kwargs):
        ...
        # Martin: comment out self.trainset and self.valset if you want to use random images
        #         also need to hardcode the number of classes in lsegmentation_module.py get_criterion()
